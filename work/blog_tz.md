...
- Инициализация: при первичном развертывании заполнить таблицу `posts` 5 тестовыми записями через сидер (или миграцию с данными), чтобы проверить отображение списка и детализации.
